...
This document is the human-readable guide to the Cursor workflow used in the DroidRun project.
...
| `droidrun` | **Actuator layer** — phone automation, MCP phone tools, Portal/APK runtime bridge. This repo executes; it does not govern. |
...
- `docs/ai/STATE.md` — **operational evidence log**; PLAN reads this to understand current state, blockers, and cross-repo effects. Every AGENT block must append an entry. **This is evidence, not product law.**
