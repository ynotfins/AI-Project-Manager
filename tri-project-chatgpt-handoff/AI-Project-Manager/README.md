...
- `open--claw` — [ynotfins/open--claw](https://github.com/ynotfins/open--claw), branch `master`, status: Phase 6C COMPLETE and post-6C hardening active (see `docs/ai/STATE.md`)
...
Current operating topology is tri-workspace:

- `AI-Project-Manager` — governance/orchestration
- `open--claw` — agent runtime/brain
...
- PLAN — Architect / Strategist (no file edits)
- AGENT — Executor / Implementer (edits files)
- DEBUG — Investigator / Forensics (no file edits)
- ASK — Scratchpad / Exploration (no file edits)
- ARCHIVE — Compressor / Handoff (docs-only updates)
